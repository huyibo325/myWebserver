...
private:
    ...
    struct sockaddr_in m_address;//通信的socker地址
    ...
    char m_real_file[FILENAME_LEN];//客户请求目标文件的完整路径，其内容等于doc_root+m_url,doc_root是网站的完整根目录
    
    struct stat m_file_stat;//文件的权限
